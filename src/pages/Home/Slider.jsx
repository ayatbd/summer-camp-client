...
const Slider = () => {
  ...
  return (
    <div
      className={`carousel h-[36rem] w-full py-24 ${
        isDarkMode
          ? "bg-gray-900"
    ...
    >
      <div id="slide1" className="carousel-item relative w-full">
        <img
          src={img4}
          className={`w-full ${isDarkMode ? "opacity-20" : ""}`}
          alt="Slide 1"
        />
        ...
        <div
          className={` p-10 rounded absolute text-black top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center ${
            isDarkMode ? "text-white bg-gray-800" : "bg-teal-500"
          }`}
        >
